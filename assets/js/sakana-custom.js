...
const Sakana = (_=>{
    ...
    const init = (options = {})=>{
        ...
        const springBaseY = 140;
        const springControlY = springBaseY + (75 - springBaseY) * springScale;
        const springTopY = springBaseY + (-100 - springBaseY) * springScale;
        ...
        const draw = _=>{
            ...
            const nx = n.x * springScale;
            const ny = springTopY - n.y * springScale;
            
            ctx.quadraticCurveTo(0, springControlY, nx, ny);
